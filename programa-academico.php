			...
			<div class="mx-md-6">
				<div class="row mx-md-5 my-md-4" id="">
					<div class="col-4 m-md-0 m-4 col-md-2">
						<img style="border-radius: 25px;" src="/assets/images/18agosto.png" alt="18 Agosto">
					</div>
				...
				<div class="row mx-md-5 my-md-4" id="">
					<div class="col-4 m-md-0 m-4 col-md-2">
						<img style="border-radius: 25px;" src="/assets/images/19agosto.png" alt="19 Agosto">
					</div>
					<div class="col-12 col-md-10">
						<ul class="list-group">
							<li class="list-group-item list-borderless">
								...
								<div class="row">
									...
									<div class="col-8 col-lg-6">
										<h4 class="titulos">Trastorno bipolar y comorbilidad
											<br>
											<b class="subtitulos">Dr. Mauricio Tohen MD Dr PH</b>
											<br>
											<b class="subtitulos-2">Profesor Distinguido y Jefe del departamento de psiquiatría
												Escuela de Medicina
								...
								<div class="row">
									...
									<div class="col-8 col-lg-6">
										<h4 class="titulos">Manejo de riesgo suicida
											...
											<br>
											<b class="subtitulos-2">Investigadora de ciencias médicas del Instituto Nacional de Psiquiatría
								...
								<div class="row">
									<div class="col-12 col-lg-12 titulos-m">
										<h3 class="cajita fechas-horas sb3">MÓDULO 3:
											...
											<br>
											<b class="subtitulos-m">Dr. Mauricio Tohen MD Dr PH</b>
											<br>
											<b class="subtitulos-m-2">Profesor Distinguido y Jefe del departamento de psiquiatría
												Escuelade Medicina
												Universidad de Nuevo México
												Albuquerque NM, EEUU</b>
										</h3>
									</div>
								</div>
							</li>
				...
				<div class="row mx-md-5 my-md-4" id="b3">
					<div class="col-4 m-md-0 m-4 col-md-2">
						<img style="border-radius: 25px;" src="/assets/images/20agosto.png" alt="20 Agosto">
					</div>
					<div class="col-12 col-md-10">
						<ul class="list-group">
							<li class="list-group-item list-borderless">
